...
export const PrimaryButton = ({ children, onClick }: {
     ...
     return (
          ...
          <button onClick={onClick} type="button" className="bg-slate-950 text-white  focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2
               ">{children}</button>
